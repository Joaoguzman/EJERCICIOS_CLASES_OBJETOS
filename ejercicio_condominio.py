class Condominio:
    def __init__(self, direccion, lista_administrador, num_guardias, num_unidades_habitacionales, lista_unidades, atributo1, atributo2, atributo3, atributo4):
        self.direccion = direccion
        self.lista_administrador = administrador
        self.lista_guardias = []
        self.__add_guardia()
    ...
    def __add_guardia(self):
        for i in range(self.num_guardias):
            self.lista_guardias.append(Guardia("x", "y", "z"))
